...
{
	public partial class zNorthwindTest2Conn_TxConnectionProvider : IDisposable, IzNorthwindTest2Conn_TxConnectionProvider
	{
		...
		public zNorthwindTest2Conn_TxConnectionProvider()
		{
			Init();
		}
