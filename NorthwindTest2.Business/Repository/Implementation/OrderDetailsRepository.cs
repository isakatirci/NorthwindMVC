...
namespace NorthwindTest2.Business.Repository
{
	...
	public partial class OrderDetailsRepository : IOrderDetailsRepository, IDisposable
	{
		...
		#region methods
		public virtual IzNorthwindTest2Conn_BaseData BaseData(IDAOOrderDetails daoOrderDetails)
		{	return (IzNorthwindTest2Conn_BaseData)(DAOOrderDetails)daoOrderDetails;	}
