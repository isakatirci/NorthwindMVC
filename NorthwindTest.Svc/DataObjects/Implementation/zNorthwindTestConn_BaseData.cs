...
{
	public partial class zNorthwindTestConn_BaseData : IDisposable, IzNorthwindTestConn_BaseData
	{
		#region members
		protected IzNorthwindTestConn_TxConnectionProvider _connectionProvider;
		static string _staticConnectionString;
		bool _isDisposed = false;
		#endregion

		#region initialisation
		public zNorthwindTestConn_BaseData()
		{
			Init();
		}
