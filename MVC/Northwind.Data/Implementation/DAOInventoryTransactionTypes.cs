...
{
	public partial class DAOInventoryTransactionTypes : zNorthwindConn_BaseData, IDAOİnventoryTransactionTypes
	{
		...
		public DAOInventoryTransactionTypes()
		{
		}
		///<Summary>
		///Select one row by primary key(s)
		///This method returns one row from the table inventory_transaction_types based on the primary key(s)
		///</Summary>
		///<returns>
		///IDAOİnventoryTransactionTypes
		///</returns>
		///<parameters>
		///string id
		///</parameters>
		public static IDAOİnventoryTransactionTypes SelectOne(string id)
		{
			Doing(null);
			MySqlCommand	command = new MySqlCommand();
			command.CommandText = "ctpr_inventory_transaction_types_getone";
			command.CommandType = CommandType.StoredProcedure;
			MySqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;

			DataTable dt = new DataTable("inventory_transaction_types");
			...
			try
			{
				...
				DAOInventoryTransactionTypes retObj = null;
				if(dt.Rows.Count > 0)
				{
					retObj = new DAOInventoryTransactionTypes();
					retObj._id					 = Convert.IsDBNull(dt.Rows[0]["id"]) ? null : (string)dt.Rows[0]["id"];
					retObj._typeName					 = Convert.IsDBNull(dt.Rows[0]["type_name"]) ? null : (string)dt.Rows[0]["type_name"];
		...
		///this method allows the object to delete itself from the table inventory_transaction_types based on its primary key
		///</Summary>
		///<returns>
		///void
		///</returns>
		...
		public virtual void Delete()
		{
			Doing(this);
			MySqlCommand	command = new MySqlCommand();
			command.CommandText = "ctpr_inventory_transaction_types_deleteone";
			command.CommandType = CommandType.StoredProcedure;
		...
		///<Summary>
		///Insert a new row
		///This method saves a new object to the table inventory_transaction_types
		///</Summary>
		///<returns>
		///void
		///</returns>
		...
		public virtual void Insert()
		{
			Doing(this);
			MySqlCommand	command = new MySqlCommand();
			command.CommandText = "ctpr_inventory_transaction_types_insertone";
			command.CommandType = CommandType.StoredProcedure;
			command.Connection = _connectionProvider.Connection;
			...
			try
			{
				...
				command.Parameters.Add(new MySqlParameter("?P_TYPE_NAME", MySqlDbType.VarChar, 150, ParameterDirection.InputOutput, true, 0, 0, "", DataRowVersion.Proposed, _typeName));
				...
				_typeName					 = Convert.IsDBNull(command.Parameters["?P_TYPE_NAME"].Value) ? null : (string)command.Parameters["?P_TYPE_NAME"].Value;
		...
		///<Summary>
		///Select all rows
		///This method returns all data rows in the table inventory_transaction_types
		///</Summary>
		///<returns>
		///List-IDAOİnventoryTransactionTypes.
		///</returns>
		///<parameters>
		///
		///</parameters>
		public static List<IDAOİnventoryTransactionTypes> SelectAll()
		{
			Doing(null);
			MySqlCommand	command = new MySqlCommand();
			command.CommandText = "ctpr_inventory_transaction_types_getall";
			command.CommandType = CommandType.StoredProcedure;
			MySqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
			...
			try
			{
				...
				List<IDAOİnventoryTransactionTypes> objList = new List<IDAOİnventoryTransactionTypes>();
				if(dt.Rows.Count > 0)
				{
					foreach(DataRow row in dt.Rows)
					{
						DAOInventoryTransactionTypes retObj = new DAOInventoryTransactionTypes();
						retObj._id					 = Convert.IsDBNull(row["id"]) ? null : (string)row["id"];
						retObj._typeName					 = Convert.IsDBNull(row["type_name"]) ? null : (string)row["type_name"];
		...
		public static Int32 SelectAllCount()
		{
			Doing(null);
			MySqlCommand	command = new MySqlCommand();
			command.CommandText = "ctpr_inventory_transaction_types_getallcount";
			command.CommandType = CommandType.StoredProcedure;
			MySqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		///This method returns specific fields of all data rows in the table using criteriaquery apiinventory_transaction_types
		///</Summary>
		///<returns>
		...
		public static IDictionary<string, IList<object>> SelectAllByCriteriaProjection(IList<IDataProjection> listProjection, IList<IDataCriterion> listCriterion, IList<IDataOrderBy> listOrder, IDataSkip dataSkip, IDataTake dataTake)
		{
			Doing(null);
			MySqlCommand	command = new MySqlCommand();
			command.CommandText = "ctpr_inventory_transaction_types_getbyprojection";
			command.CommandType = CommandType.StoredProcedure;
			MySqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
			...
			try
			{
				...
				foreach (IDataProjection projection in listProjection)
				{
					...
					foreach (DataRow row in dt.Rows)
					{
						...
						if (string.Compare(projection.Member, "type_name", true) == 0) lst.Add(Convert.IsDBNull(row["type_name"]) ? null : (string)row["type_name"]);
					}
				}
				return dict;
			}
		...
		///This method returns all data rows in the table using criteriaquery api inventory_transaction_types
		///</Summary>
		///<returns>
		///List-IDAOİnventoryTransactionTypes.
		///</returns>
		...
		///</parameters>
		public static List<IDAOİnventoryTransactionTypes> SelectAllByCriteria(IList<IDataCriterion> listCriterion, IList<IDataOrderBy> listOrder, IDataSkip dataSkip, IDataTake dataTake)
		{
			Doing(null);
			MySqlCommand	command = new MySqlCommand();
			command.CommandText = "ctpr_inventory_transaction_types_getbycriteria";
			command.CommandType = CommandType.StoredProcedure;
			MySqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		public static Int32 SelectAllByCriteriaCount(IList<IDataCriterion> listCriterion)
		{
			Doing(null);
			MySqlCommand	command = new MySqlCommand();
			command.CommandText = "ctpr_inventory_transaction_types_getbycriteriacount";
			command.CommandType = CommandType.StoredProcedure;
			MySqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		///This method allows the object to update itself in the table inventory_transaction_types based on its primary key(s)
		///</Summary>
		///<returns>
		///void
		///</returns>
		...
		public virtual void Update()
		{
			Doing(this);
			MySqlCommand	command = new MySqlCommand();
			command.CommandText = "ctpr_inventory_transaction_types_updateone";
			command.CommandType = CommandType.StoredProcedure;
			command.Connection = _connectionProvider.Connection;
