...
{
	public partial class DAOOrders : zNorthwindRestApiConn_BaseData, IDAOOrders
	{
		...
		///</returns>
		///<parameters>
		///IzNorthwindRestApiConn_TxConnectionProvider connectionProvider, string customerID
		///</parameters>
		public static void DeleteAllByCustomerID(IzNorthwindRestApiConn_TxConnectionProvider connectionProvider, string customerID)
		{
			Doing(null);
			SqlCommand	command = new SqlCommand();
		...
		///</returns>
		///<parameters>
		///IzNorthwindRestApiConn_TxConnectionProvider connectionProvider, Int32? employeeID
		///</parameters>
		public static void DeleteAllByEmployeeID(IzNorthwindRestApiConn_TxConnectionProvider connectionProvider, Int32? employeeID)
		{
			Doing(null);
			SqlCommand	command = new SqlCommand();
		...
		///</returns>
		///<parameters>
		///IzNorthwindRestApiConn_TxConnectionProvider connectionProvider, Int32? shipVia
		///</parameters>
		public static void DeleteAllByShipVia(IzNorthwindRestApiConn_TxConnectionProvider connectionProvider, Int32? shipVia)
		{
			Doing(null);
			SqlCommand	command = new SqlCommand();
