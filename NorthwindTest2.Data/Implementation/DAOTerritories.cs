...
{
	public partial class DAOTerritories : zNorthwindTest2Conn_BaseData, IDAOTerritories
	{
		...
		///</returns>
		///<parameters>
		///IzNorthwindTest2Conn_TxConnectionProvider connectionProvider, Int32? regionID
		///</parameters>
		public static void DeleteAllByRegionID(IzNorthwindTest2Conn_TxConnectionProvider connectionProvider, Int32? regionID)
		{
			Doing(null);
			SqlCommand	command = new SqlCommand();
