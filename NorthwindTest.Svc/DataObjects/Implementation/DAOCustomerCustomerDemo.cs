...
{
	public partial class DAOCustomerCustomerDemo : zNorthwindTestConn_BaseData, IDAOCustomerCustomerDemo
	{
		...
		///</Summary>
		///<returns>
		///IDAOCustomerCustomerDemo
		///</returns>
		///<parameters>
		///string customerID, string customerTypeID
		///</parameters>
		public static IDAOCustomerCustomerDemo SelectOne(string customerID, string customerTypeID)
		{
			Doing(null);
		...
		///string customerID
		///</parameters>
		public static IList<IDAOCustomerCustomerDemo> SelectAllByCustomerID(string customerID)
		{
			Doing(null);
			SqlCommand	command = new SqlCommand();
		...
		///</returns>
		///<parameters>
		///IzNorthwindTestConn_TxConnectionProvider connectionProvider, string customerID
		///</parameters>
		public static void DeleteAllByCustomerID(IzNorthwindTestConn_TxConnectionProvider connectionProvider, string customerID)
		{
			Doing(null);
			SqlCommand	command = new SqlCommand();
		...
		///</returns>
		///<parameters>
		///IzNorthwindTestConn_TxConnectionProvider connectionProvider, string customerTypeID
		///</parameters>
		public static void DeleteAllByCustomerTypeID(IzNorthwindTestConn_TxConnectionProvider connectionProvider, string customerTypeID)
		{
			Doing(null);
			SqlCommand	command = new SqlCommand();
		...
		///
		///</parameters>
		public static IList<IDAOCustomerCustomerDemo> SelectAll()
		{
			Doing(null);
			SqlCommand	command = new SqlCommand();
