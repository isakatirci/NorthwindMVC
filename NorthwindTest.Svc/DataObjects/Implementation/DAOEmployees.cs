...
{
	public partial class DAOEmployees : zNorthwindTestConn_BaseData, IDAOEmployees
	{
		...
		///</returns>
		///<parameters>
		///IzNorthwindTestConn_TxConnectionProvider connectionProvider, Int32? reportsTo
		///</parameters>
		public static void DeleteAllByReportsTo(IzNorthwindTestConn_TxConnectionProvider connectionProvider, Int32? reportsTo)
		{
			Doing(null);
			SqlCommand	command = new SqlCommand();
