...
{
	public partial class DAOProducts : zNorthwindClassLibrayConn_BaseData, IDAOProducts
	{
		...
		public virtual void Insert()
		{
			...
			try
			{
				command.Parameters.Add(new MySqlParameter("?P_SUPPLIER_IDS", MySqlDbType.LongText, -1, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, (object)_supplierIds?? (object)DBNull.Value));
				...
				command.Parameters.Add(new MySqlParameter("?P_LIST_PRICE", MySqlDbType.VarChar, 0, ParameterDirection.InputOutput, true, 19, 4, "", DataRowVersion.Proposed, _listPrice));
				...
				command.Parameters.Add(new MySqlParameter("?P_QUANTITY_PER_UNIT", MySqlDbType.VarChar, 150, ParameterDirection.InputOutput, true, 0, 0, "", DataRowVersion.Proposed, _quantityPerUnit));
				command.Parameters.Add(new MySqlParameter("?P_DISCONTINUED", MySqlDbType.VarChar, 0, ParameterDirection.InputOutput, true, 3, 0, "", DataRowVersion.Proposed, _discontinued));
				command.Parameters.Add(new MySqlParameter("?P_MINIMUM_REORDER_QUANTITY", MySqlDbType.VarChar, 0, ParameterDirection.InputOutput, true, 10, 0, "", DataRowVersion.Proposed, _minimumReorderQuantity));
				...
				_listPrice					 = Convert.IsDBNull(command.Parameters["?P_LIST_PRICE"].Value) ? null : (string)command.Parameters["?P_LIST_PRICE"].Value;
				...
				_quantityPerUnit					 = Convert.IsDBNull(command.Parameters["?P_QUANTITY_PER_UNIT"].Value) ? null : (string)command.Parameters["?P_QUANTITY_PER_UNIT"].Value;
				_discontinued					 = Convert.IsDBNull(command.Parameters["?P_DISCONTINUED"].Value) ? null : (string)command.Parameters["?P_DISCONTINUED"].Value;
				_minimumReorderQuantity					 = Convert.IsDBNull(command.Parameters["?P_MINIMUM_REORDER_QUANTITY"].Value) ? null : (string)command.Parameters["?P_MINIMUM_REORDER_QUANTITY"].Value;
