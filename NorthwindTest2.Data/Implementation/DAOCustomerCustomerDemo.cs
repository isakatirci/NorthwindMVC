...
{
	public partial class DAOCustomerCustomerDemo : zNorthwindTest2Conn_BaseData, IDAOCustomerCustomerDemo
	{
		...
		///</returns>
		///<parameters>
		///IzNorthwindTest2Conn_TxConnectionProvider connectionProvider, string customerTypeID
		///</parameters>
		public static void DeleteAllByCustomerTypeID(IzNorthwindTest2Conn_TxConnectionProvider connectionProvider, string customerTypeID)
		{
			Doing(null);
			SqlCommand	command = new SqlCommand();
