...
{
	public partial class zNorthwindTestConn_BaseBusiness : IzNorthwindTestConn_BaseBusiness
	{
		#region initialization
		public zNorthwindTestConn_BaseBusiness()
		{
			Init();
		}
		...
		protected virtual void RegisterDataObject(IRepositoryConnection repo, IzNorthwindTestConn_BaseData dataObject)
		{
				if(dataObject != null)
