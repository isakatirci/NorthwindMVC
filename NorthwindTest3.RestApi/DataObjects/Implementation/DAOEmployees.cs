...
{
	public partial class DAOEmployees : zNorthwindTest3Conn_BaseData
	{
		...
		///Int32? employeeID
		///</parameters>
		public static DAOEmployees SelectOne(Int32? employeeID)
		{
		...
		///Int32? reportsTo
		///</parameters>
		public static IList<DAOEmployees> SelectAllByReportsTo(Int32? reportsTo)
		{
			SqlCommand	command = new SqlCommand();
			...
			try
			{
				...
				List<DAOEmployees> objList = new List<DAOEmployees>();
				if(dt.Rows.Count > 0)
				{
		...
		///</returns>
		///<parameters>
		///zNorthwindTest3Conn_TxConnectionProvider connectionProvider, Int32? reportsTo
		///</parameters>
		public static void DeleteAllByReportsTo(zNorthwindTest3Conn_TxConnectionProvider connectionProvider, Int32? reportsTo)
		{
			SqlCommand	command = new SqlCommand();
		...
		///
		///</parameters>
		public static IList<DAOEmployees> SelectAll()
		{
			SqlCommand	command = new SqlCommand();
		...
		///</parameters>
		public static IList<DAOEmployees> SelectAllByCriteria(IList<IDataCriterion> listCriterion, IList<IDataOrderBy> listOrder, IDataSkip dataSkip, IDataTake dataTake)
		{
			SqlCommand	command = new SqlCommand();
