...
{
	public partial class DAOOrderDetails : zNorthwindTestConn_BaseData, IDAOOrderDetails
	{
		...
		///</returns>
		///<parameters>
		///IzNorthwindTestConn_TxConnectionProvider connectionProvider, Int32? orderID
		///</parameters>
		public static void DeleteAllByOrderID(IzNorthwindTestConn_TxConnectionProvider connectionProvider, Int32? orderID)
		{
			Doing(null);
			SqlCommand	command = new SqlCommand();
		...
		///</returns>
		///<parameters>
		///IzNorthwindTestConn_TxConnectionProvider connectionProvider, Int32? productID
		///</parameters>
		public static void DeleteAllByProductID(IzNorthwindTestConn_TxConnectionProvider connectionProvider, Int32? productID)
		{
			Doing(null);
			SqlCommand	command = new SqlCommand();
