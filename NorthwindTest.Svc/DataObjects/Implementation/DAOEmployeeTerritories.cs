...
{
	public partial class DAOEmployeeTerritories : zNorthwindTestConn_BaseData, IDAOEmployeeTerritories
	{
		...
		///</returns>
		///<parameters>
		///IzNorthwindTestConn_TxConnectionProvider connectionProvider, string territoryID
		///</parameters>
		public static void DeleteAllByTerritoryID(IzNorthwindTestConn_TxConnectionProvider connectionProvider, string territoryID)
		{
			Doing(null);
			SqlCommand	command = new SqlCommand();
