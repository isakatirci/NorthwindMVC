...
{
	public partial class DAOIdentityUserRole : zNorthwindRestApiConn_BaseData, IDAOIdentityUserRole
	{
		...
		///</returns>
		///<parameters>
		///IzNorthwindRestApiConn_TxConnectionProvider connectionProvider, Int32? roleId
		///</parameters>
		public static void DeleteAllByRoleId(IzNorthwindRestApiConn_TxConnectionProvider connectionProvider, Int32? roleId)
		{
			Doing(null);
			SqlCommand	command = new SqlCommand();
