...
{
	public partial class DAOTerritories : zNorthwindTestConn_BaseData, IDAOTerritories
	{
		...
		///</returns>
		///<parameters>
		///IzNorthwindTestConn_TxConnectionProvider connectionProvider, Int32? regionID
		///</parameters>
		public static void DeleteAllByRegionID(IzNorthwindTestConn_TxConnectionProvider connectionProvider, Int32? regionID)
		{
			Doing(null);
			SqlCommand	command = new SqlCommand();
