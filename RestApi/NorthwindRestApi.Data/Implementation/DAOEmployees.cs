...
{
	public partial class DAOEmployees : zNorthwindRestApiConn_BaseData, IDAOEmployees
	{
		...
		///</returns>
		///<parameters>
		///IzNorthwindRestApiConn_TxConnectionProvider connectionProvider, Int32? reportsTo
		///</parameters>
		public static void DeleteAllByReportsTo(IzNorthwindRestApiConn_TxConnectionProvider connectionProvider, Int32? reportsTo)
		{
			Doing(null);
			SqlCommand	command = new SqlCommand();
