...
{
	public partial class zNorthwindTest3Conn_BaseData : IDisposable
	{
		#region members
		protected zNorthwindTest3Conn_TxConnectionProvider _connectionProvider;
		static string _staticConnectionString;
		bool _isDisposed = false;
		#endregion

		#region initialisation
		public zNorthwindTest3Conn_BaseData()
		{
			Init();
		}
		...
		public virtual zNorthwindTest3Conn_TxConnectionProvider ConnectionProvider
		{
			set
			{
				if(value == null)
		...
		public static string StaticConnectionString
		{
			...
			get
			{
				...
				return zNorthwindTest3Conn_ConfigWrapper.GetConnectionString("6fb29ab7-2472-4239-b818-d8497b0732f4");
			}
		}
		#endregion
