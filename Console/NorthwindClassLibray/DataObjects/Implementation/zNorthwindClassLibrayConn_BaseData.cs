...
{
	public partial class zNorthwindClassLibrayConn_BaseData : IzNorthwindClassLibrayConn_BaseData
	{
		#region members
		protected IzNorthwindClassLibrayConn_TxConnectionProvider _connectionProvider;
		static string _staticConnectionString;
		bool _isDisposed = false;
		#endregion

		#region initialisation
		public zNorthwindClassLibrayConn_BaseData()
		{
			Init();
		}
