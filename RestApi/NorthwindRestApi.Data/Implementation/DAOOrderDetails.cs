...
{
	public partial class DAOOrderDetails : zNorthwindRestApiConn_BaseData, IDAOOrderDetails
	{
		...
		///</returns>
		///<parameters>
		///IzNorthwindRestApiConn_TxConnectionProvider connectionProvider, Int32? orderID
		///</parameters>
		public static void DeleteAllByOrderID(IzNorthwindRestApiConn_TxConnectionProvider connectionProvider, Int32? orderID)
		{
			Doing(null);
			SqlCommand	command = new SqlCommand();
		...
		///</returns>
		///<parameters>
		///IzNorthwindRestApiConn_TxConnectionProvider connectionProvider, Int32? productID
		///</parameters>
		public static void DeleteAllByProductID(IzNorthwindRestApiConn_TxConnectionProvider connectionProvider, Int32? productID)
		{
			Doing(null);
			SqlCommand	command = new SqlCommand();
