...
namespace NorthwindRestApi.Business.Repository
{
	...
	public partial class OrderDetailsRepository : IOrderDetailsRepository, IDisposable
	{
		...
		#region methods
		public virtual IzNorthwindRestApiConn_BaseData BaseData(IDAOOrderDetails daoOrderDetails)
		{	return (IzNorthwindRestApiConn_BaseData)(DAOOrderDetails)daoOrderDetails;	}
