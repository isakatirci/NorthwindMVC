...
{
	public partial class DAOPurchaseOrderDetails : zNorthwindConn_BaseData, IDAOPurchaseOrderDetails
	{
		...
		public static IDAOPurchaseOrderDetails SelectOne(string id)
		{
			...
			try
			{
				...
				if(dt.Rows.Count > 0)
				{
					...
					retObj._postedToİnventory					 = Convert.IsDBNull(dt.Rows[0]["posted_to_inventory"]) ? null : (string)dt.Rows[0]["posted_to_inventory"];
		...
		///</parameters>
		public static List<IDAOPurchaseOrderDetails> SelectAllByPurchaseOrderİd(string purchaseOrderİd)
		{
			Doing(null);
			MySqlCommand	command = new MySqlCommand();
			...
			try
			{
				command.Parameters.Add(new MySqlParameter("?P_PURCHASE_ORDER_İD", MySqlDbType.VarChar, 0, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, (object)purchaseOrderİd?? (object)DBNull.Value));
				...
				if(dt.Rows.Count > 0)
				{
					foreach(DataRow row in dt.Rows)
					{
						...
						retObj._postedToİnventory					 = Convert.IsDBNull(row["posted_to_inventory"]) ? null : (string)row["posted_to_inventory"];
		...
		///string productİd
		///</parameters>
		public static List<IDAOPurchaseOrderDetails> SelectAllByProductİd(string productİd)
		{
			Doing(null);
			MySqlCommand	command = new MySqlCommand();
		...
		///string inventoryİd
		///</parameters>
		public static List<IDAOPurchaseOrderDetails> SelectAllByİnventoryİd(string inventoryİd)
		{
			Doing(null);
			MySqlCommand	command = new MySqlCommand();
			...
			try
			{
				command.Parameters.Add(new MySqlParameter("?P_İNVENTORY_İD", MySqlDbType.VarChar, 0, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, (object)inventoryİd?? (object)DBNull.Value));
		...
		///string inventoryİd
		///</parameters>
		public static Int32 SelectAllByİnventoryİdCount(string inventoryİd)
		{
			Doing(null);
			MySqlCommand	command = new MySqlCommand();
		...
		///</returns>
		///<parameters>
		///IzNorthwindConn_TxConnectionProvider connectionProvider, string inventoryİd
		///</parameters>
		public static void DeleteAllByİnventoryİd(IzNorthwindConn_TxConnectionProvider connectionProvider, string inventoryİd)
		{
			Doing(null);
			MySqlCommand	command = new MySqlCommand();
		...
		public virtual void Insert()
		{
			...
			try
			{
				...
				command.Parameters.Add(new MySqlParameter("?P_UNİT_COST", MySqlDbType.VarChar, 0, ParameterDirection.InputOutput, true, 19, 4, "", DataRowVersion.Proposed, _unitCost));
				command.Parameters.Add(new MySqlParameter("?P_DATE_RECEİVED", MySqlDbType.VarChar, 0, ParameterDirection.InputOutput, true, 0, 0, "", DataRowVersion.Proposed, _dateReceived));
				command.Parameters.Add(new MySqlParameter("?P_POSTED_TO_İNVENTORY", MySqlDbType.VarChar, 0, ParameterDirection.InputOutput, true, 3, 0, "", DataRowVersion.Proposed, _postedToİnventory));
				...
				_unitCost					 = Convert.IsDBNull(command.Parameters["?P_UNİT_COST"].Value) ? null : (string)command.Parameters["?P_UNİT_COST"].Value;
				_dateReceived					 = Convert.IsDBNull(command.Parameters["?P_DATE_RECEİVED"].Value) ? null : (string)command.Parameters["?P_DATE_RECEİVED"].Value;
				_postedToİnventory					 = Convert.IsDBNull(command.Parameters["?P_POSTED_TO_İNVENTORY"].Value) ? null : (string)command.Parameters["?P_POSTED_TO_İNVENTORY"].Value;
		...
		public string PostedToİnventory
		{
			get
			{
