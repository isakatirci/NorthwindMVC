...
{
	public partial class DAOProducts : zNorthwindTest2Conn_BaseData, IDAOProducts
	{
		...
		///</returns>
		///<parameters>
		///IzNorthwindTest2Conn_TxConnectionProvider connectionProvider, Int32? supplierID
		///</parameters>
		public static void DeleteAllBySupplierID(IzNorthwindTest2Conn_TxConnectionProvider connectionProvider, Int32? supplierID)
		{
			Doing(null);
			SqlCommand	command = new SqlCommand();
		...
		///</returns>
		///<parameters>
		///IzNorthwindTest2Conn_TxConnectionProvider connectionProvider, Int32? categoryID
		///</parameters>
		public static void DeleteAllByCategoryID(IzNorthwindTest2Conn_TxConnectionProvider connectionProvider, Int32? categoryID)
		{
			Doing(null);
			SqlCommand	command = new SqlCommand();
