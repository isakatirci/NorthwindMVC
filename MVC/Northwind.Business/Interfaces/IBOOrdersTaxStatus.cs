...
namespace Northwind.Business.Interfaces
{
	...
	///This is the interface definition for the class BOOrdersTaxStatus.
	///</Summary>
	public partial interface IBOOrdersTaxStatus 
	{
		...
		IOrdersTaxStatusRepository OrdersTaxStatusRepository	{	set;}
		
		IOrdersRepository OrdersRepository	{	set;}
		
		string İd	{	get;	set;}
		
		string TaxStatusName	{	get;	set;}
