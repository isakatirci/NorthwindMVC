...
{
	public partial class zNorthwindRestApiConn_BaseBusiness : IzNorthwindRestApiConn_BaseBusiness
	{
		#region initialization
		public zNorthwindRestApiConn_BaseBusiness()
		{
			Init();
		}
		...
		protected virtual void RegisterDataObject(IRepositoryConnection repo, IzNorthwindRestApiConn_BaseData dataObject)
		{
				if(dataObject != null)
