...
{
    public class UnitOfWorkImp : zNorthwindTest3Conn_BaseBusiness, IUnitOfWork
    {
        private enum OpType
        ...
        public bool Commit(out string message)
        {
            ...
            RegisterObjects();
            this.BeginTransaction(transName);
            try
            {
            ...
            {
                base.RollbackTransaction(transName);
                message = ex.Message;
                return false;
            }
        }
        ...
        {
            foreach (var op in _opList)
                RegisterBusinessObject((zNorthwindTest3Conn_BaseBusiness)op.Item1);
        }
    ...
    public class UnitOfWorkForwarder : zNorthwindTest3Conn_BaseBusiness, IUnitOfWorkEntity
    {
