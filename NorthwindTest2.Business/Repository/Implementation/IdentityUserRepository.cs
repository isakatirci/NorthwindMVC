...
namespace NorthwindTest2.Business.Repository
{
	...
	public partial class IdentityUserRepository : IIdentityUserRepository, IDisposable
	{
		...
		#region methods
		public virtual IzNorthwindTest2Conn_BaseData BaseData(IDAOIdentityUser daoIdentityUser)
		{	return (IzNorthwindTest2Conn_BaseData)(DAOIdentityUser)daoIdentityUser;	}
