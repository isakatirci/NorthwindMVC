...
{
	public partial class DAOPurchaseOrderStatus : zNorthwindConn_BaseData, IDAOPurchaseOrderStatus
	{
		...
		public DAOPurchaseOrderStatus()
		{
		}
		///<Summary>
		///Select one row by primary key(s)
		///This method returns one row from the table purchase_order_status based on the primary key(s)
		///</Summary>
		///<returns>
		///IDAOPurchaseOrderStatus
		///</returns>
		///<parameters>
		///string id
		///</parameters>
		public static IDAOPurchaseOrderStatus SelectOne(string id)
		{
			Doing(null);
			MySqlCommand	command = new MySqlCommand();
			command.CommandText = "ctpr_purchase_order_status_getone";
			command.CommandType = CommandType.StoredProcedure;
			MySqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;

			DataTable dt = new DataTable("purchase_order_status");
			...
			try
			{
				...
				DAOPurchaseOrderStatus retObj = null;
				if(dt.Rows.Count > 0)
				{
					retObj = new DAOPurchaseOrderStatus();
		...
		public virtual void Delete()
		{
			Doing(this);
			MySqlCommand	command = new MySqlCommand();
			command.CommandText = "ctpr_purchase_order_status_deleteone";
			command.CommandType = CommandType.StoredProcedure;
		...
		public virtual void Insert()
		{
			Doing(this);
			MySqlCommand	command = new MySqlCommand();
			command.CommandText = "ctpr_purchase_order_status_insertone";
			command.CommandType = CommandType.StoredProcedure;
			command.Connection = _connectionProvider.Connection;
			...
			try
			{
				...
				command.Parameters.Add(new MySqlParameter("?P_STATUS", MySqlDbType.VarChar, 150, ParameterDirection.InputOutput, true, 0, 0, "", DataRowVersion.Proposed, _status));
				...
				_status					 = Convert.IsDBNull(command.Parameters["?P_STATUS"].Value) ? null : (string)command.Parameters["?P_STATUS"].Value;
		...
		///<Summary>
		///Select all rows
		///This method returns all data rows in the table purchase_order_status
		///</Summary>
		///<returns>
		///List-IDAOPurchaseOrderStatus.
		///</returns>
		///<parameters>
		///
		///</parameters>
		public static List<IDAOPurchaseOrderStatus> SelectAll()
		{
			Doing(null);
			MySqlCommand	command = new MySqlCommand();
			command.CommandText = "ctpr_purchase_order_status_getall";
			command.CommandType = CommandType.StoredProcedure;
			MySqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
			...
			try
			{
				...
				List<IDAOPurchaseOrderStatus> objList = new List<IDAOPurchaseOrderStatus>();
				if(dt.Rows.Count > 0)
				{
					foreach(DataRow row in dt.Rows)
					{
						DAOPurchaseOrderStatus retObj = new DAOPurchaseOrderStatus();
		...
		public static Int32 SelectAllCount()
		{
			Doing(null);
			MySqlCommand	command = new MySqlCommand();
			command.CommandText = "ctpr_purchase_order_status_getallcount";
			command.CommandType = CommandType.StoredProcedure;
			MySqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		///This method returns specific fields of all data rows in the table using criteriaquery apipurchase_order_status
		///</Summary>
		///<returns>
		...
		public static IDictionary<string, IList<object>> SelectAllByCriteriaProjection(IList<IDataProjection> listProjection, IList<IDataCriterion> listCriterion, IList<IDataOrderBy> listOrder, IDataSkip dataSkip, IDataTake dataTake)
		{
			Doing(null);
			MySqlCommand	command = new MySqlCommand();
			command.CommandText = "ctpr_purchase_order_status_getbyprojection";
			command.CommandType = CommandType.StoredProcedure;
			MySqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
			...
			try
			{
				...
				foreach (IDataProjection projection in listProjection)
				{
					...
					foreach (DataRow row in dt.Rows)
					{
						...
						if (string.Compare(projection.Member, "status", true) == 0) lst.Add(Convert.IsDBNull(row["status"]) ? null : (string)row["status"]);
					}
				}
				return dict;
			}
		...
		///This method returns all data rows in the table using criteriaquery api purchase_order_status
		///</Summary>
		///<returns>
		///List-IDAOPurchaseOrderStatus.
		///</returns>
		...
		///</parameters>
		public static List<IDAOPurchaseOrderStatus> SelectAllByCriteria(IList<IDataCriterion> listCriterion, IList<IDataOrderBy> listOrder, IDataSkip dataSkip, IDataTake dataTake)
		{
			Doing(null);
			MySqlCommand	command = new MySqlCommand();
			command.CommandText = "ctpr_purchase_order_status_getbycriteria";
			command.CommandType = CommandType.StoredProcedure;
			MySqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		public static Int32 SelectAllByCriteriaCount(IList<IDataCriterion> listCriterion)
		{
			Doing(null);
			MySqlCommand	command = new MySqlCommand();
			command.CommandText = "ctpr_purchase_order_status_getbycriteriacount";
			command.CommandType = CommandType.StoredProcedure;
			MySqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		public virtual void Update()
		{
			Doing(this);
			MySqlCommand	command = new MySqlCommand();
			command.CommandText = "ctpr_purchase_order_status_updateone";
			command.CommandType = CommandType.StoredProcedure;
			command.Connection = _connectionProvider.Connection;
