...
{
	public partial class DAOOrders : zNorthwindTest3Conn_BaseData
	{
		...
		///Int32? orderID
		///</parameters>
		public static DAOOrders SelectOne(Int32? orderID)
		{
		...
		///string customerID
		///</parameters>
		public static IList<DAOOrders> SelectAllByCustomerID(string customerID)
		{
			SqlCommand	command = new SqlCommand();
			...
			try
			{
				...
				List<DAOOrders> objList = new List<DAOOrders>();
				if(dt.Rows.Count > 0)
				{
		...
		///Int32? employeeID
		///</parameters>
		public static IList<DAOOrders> SelectAllByEmployeeID(Int32? employeeID)
		{
			SqlCommand	command = new SqlCommand();
		...
		///Int32? shipVia
		///</parameters>
		public static IList<DAOOrders> SelectAllByShipVia(Int32? shipVia)
		{
			SqlCommand	command = new SqlCommand();
		...
		///</returns>
		///<parameters>
		///zNorthwindTest3Conn_TxConnectionProvider connectionProvider, Int32? shipVia
		///</parameters>
		public static void DeleteAllByShipVia(zNorthwindTest3Conn_TxConnectionProvider connectionProvider, Int32? shipVia)
		{
			SqlCommand	command = new SqlCommand();
		...
		///
		///</parameters>
		public static IList<DAOOrders> SelectAll()
		{
			SqlCommand	command = new SqlCommand();
		...
		///</parameters>
		public static IList<DAOOrders> SelectAllByCriteria(IList<IDataCriterion> listCriterion, IList<IDataOrderBy> listOrder, IDataSkip dataSkip, IDataTake dataTake)
		{
			SqlCommand	command = new SqlCommand();
