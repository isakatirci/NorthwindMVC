...
{
	public partial class DAOOrders : zNorthwindTestConn_BaseData, IDAOOrders
	{
		...
		///</returns>
		///<parameters>
		///IzNorthwindTestConn_TxConnectionProvider connectionProvider, Int32? employeeID
		///</parameters>
		public static void DeleteAllByEmployeeID(IzNorthwindTestConn_TxConnectionProvider connectionProvider, Int32? employeeID)
		{
			Doing(null);
			SqlCommand	command = new SqlCommand();
		...
		///</returns>
		///<parameters>
		///IzNorthwindTestConn_TxConnectionProvider connectionProvider, Int32? shipVia
		///</parameters>
		public static void DeleteAllByShipVia(IzNorthwindTestConn_TxConnectionProvider connectionProvider, Int32? shipVia)
		{
			Doing(null);
			SqlCommand	command = new SqlCommand();
