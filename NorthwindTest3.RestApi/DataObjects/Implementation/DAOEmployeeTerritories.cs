...
{
	public partial class DAOEmployeeTerritories : zNorthwindTest3Conn_BaseData
	{
		...
		///</parameters>
		public static DAOEmployeeTerritories SelectOne(Int32? employeeID, string territoryID)
		{
		...
		///</Summary>
		///<returns>
		///IList-DAOEmployeeTerritories.
		///</returns>
		///<parameters>
		///Int32? employeeID
		///</parameters>
		public static IList<DAOEmployeeTerritories> SelectAllByEmployeeID(Int32? employeeID)
		{
			SqlCommand	command = new SqlCommand();
			...
			try
			{
				...
				List<DAOEmployeeTerritories> objList = new List<DAOEmployeeTerritories>();
				if(dt.Rows.Count > 0)
				{
		...
		///</returns>
		///<parameters>
		///zNorthwindTest3Conn_TxConnectionProvider connectionProvider, Int32? employeeID
		///</parameters>
		public static void DeleteAllByEmployeeID(zNorthwindTest3Conn_TxConnectionProvider connectionProvider, Int32? employeeID)
		{
			SqlCommand	command = new SqlCommand();
		...
		///string territoryID
		///</parameters>
		public static IList<DAOEmployeeTerritories> SelectAllByTerritoryID(string territoryID)
		{
			SqlCommand	command = new SqlCommand();
		...
		///</returns>
		///<parameters>
		///zNorthwindTest3Conn_TxConnectionProvider connectionProvider, string territoryID
		///</parameters>
		public static void DeleteAllByTerritoryID(zNorthwindTest3Conn_TxConnectionProvider connectionProvider, string territoryID)
		{
			SqlCommand	command = new SqlCommand();
		...
		///
		///</parameters>
		public static IList<DAOEmployeeTerritories> SelectAll()
		{
			SqlCommand	command = new SqlCommand();
		...
		///</parameters>
		public static IList<DAOEmployeeTerritories> SelectAllByCriteria(IList<IDataCriterion> listCriterion, IList<IDataOrderBy> listOrder, IDataSkip dataSkip, IDataTake dataTake)
		{
			SqlCommand	command = new SqlCommand();
