...
{
	public partial class zNorthwindTest2Conn_BaseData : IDisposable, IzNorthwindTest2Conn_BaseData
	{
		#region members
		protected IzNorthwindTest2Conn_TxConnectionProvider _connectionProvider;
		static string _staticConnectionString;
		bool _isDisposed = false;
		#endregion

		#region initialisation
		public zNorthwindTest2Conn_BaseData()
		{
			Init();
		}
		...
		public static string StaticConnectionString
		{
			...
			get
			{
				...
				return zNorthwindTest2Conn_ConfigWrapper.GetConnectionString("b5b71261-af47-4511-aea0-77f3b1c002d8");
			}
		}
		#endregion
