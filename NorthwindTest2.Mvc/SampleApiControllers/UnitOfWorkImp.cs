...
{
    public class UnitOfWorkImp : zNorthwindTest2Conn_BaseBusiness, IUnitOfWork
    {
        private enum OpType
    ...
    public class UnitOfWorkForwarder : zNorthwindTest2Conn_BaseBusiness, IUnitOfWorkEntity
    {
