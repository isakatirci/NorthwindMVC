...
{
	public partial class DAOProducts : zNorthwindTestConn_BaseData, IDAOProducts
	{
		...
		///</returns>
		///<parameters>
		///IzNorthwindTestConn_TxConnectionProvider connectionProvider, Int32? supplierID
		///</parameters>
		public static void DeleteAllBySupplierID(IzNorthwindTestConn_TxConnectionProvider connectionProvider, Int32? supplierID)
		{
			Doing(null);
			SqlCommand	command = new SqlCommand();
		...
		///</returns>
		///<parameters>
		///IzNorthwindTestConn_TxConnectionProvider connectionProvider, Int32? categoryID
		///</parameters>
		public static void DeleteAllByCategoryID(IzNorthwindTestConn_TxConnectionProvider connectionProvider, Int32? categoryID)
		{
			Doing(null);
			SqlCommand	command = new SqlCommand();
