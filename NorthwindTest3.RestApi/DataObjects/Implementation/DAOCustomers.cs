...
{
	public partial class DAOCustomers : zNorthwindTest3Conn_BaseData
	{
		...
		///string customerID
		///</parameters>
		public static DAOCustomers SelectOne(string customerID)
		{
		...
		///
		///</parameters>
		public static IList<DAOCustomers> SelectAll()
		{
			SqlCommand	command = new SqlCommand();
			...
			try
			{
				...
				List<DAOCustomers> objList = new List<DAOCustomers>();
				if(dt.Rows.Count > 0)
				{
		...
		///</parameters>
		public static IList<DAOCustomers> SelectAllByCriteria(IList<IDataCriterion> listCriterion, IList<IDataOrderBy> listOrder, IDataSkip dataSkip, IDataTake dataTake)
		{
			SqlCommand	command = new SqlCommand();
