...
{
	public partial class DAOEmployeeTerritories : zNorthwindRestApiConn_BaseData, IDAOEmployeeTerritories
	{
		...
		///</returns>
		///<parameters>
		///IzNorthwindRestApiConn_TxConnectionProvider connectionProvider, string territoryID
		///</parameters>
		public static void DeleteAllByTerritoryID(IzNorthwindRestApiConn_TxConnectionProvider connectionProvider, string territoryID)
		{
			Doing(null);
			SqlCommand	command = new SqlCommand();
