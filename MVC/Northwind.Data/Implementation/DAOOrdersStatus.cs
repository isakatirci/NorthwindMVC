...
{
	public partial class DAOOrdersStatus : zNorthwindConn_BaseData, IDAOOrdersStatus
	{
		...
		public DAOOrdersStatus()
		{
		}
		///<Summary>
		///Select one row by primary key(s)
		///This method returns one row from the table orders_status based on the primary key(s)
		///</Summary>
		///<returns>
		///IDAOOrdersStatus
		///</returns>
		...
		///string id
		///</parameters>
		public static IDAOOrdersStatus SelectOne(string id)
		{
			Doing(null);
			MySqlCommand	command = new MySqlCommand();
			command.CommandText = "ctpr_orders_status_getone";
			command.CommandType = CommandType.StoredProcedure;
			MySqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;

			DataTable dt = new DataTable("orders_status");
			...
			try
			{
				...
				DAOOrdersStatus retObj = null;
				if(dt.Rows.Count > 0)
				{
					retObj = new DAOOrdersStatus();
		...
		///this method allows the object to delete itself from the table orders_status based on its primary key
		///</Summary>
		///<returns>
		///void
		///</returns>
		...
		public virtual void Delete()
		{
			Doing(this);
			MySqlCommand	command = new MySqlCommand();
			command.CommandText = "ctpr_orders_status_deleteone";
			command.CommandType = CommandType.StoredProcedure;
		...
		///<Summary>
		///Insert a new row
		///This method saves a new object to the table orders_status
		///</Summary>
		///<returns>
		///void
		///</returns>
		...
		public virtual void Insert()
		{
			Doing(this);
			MySqlCommand	command = new MySqlCommand();
			command.CommandText = "ctpr_orders_status_insertone";
			command.CommandType = CommandType.StoredProcedure;
			command.Connection = _connectionProvider.Connection;
		...
		///<Summary>
		///Select all rows
		///This method returns all data rows in the table orders_status
		///</Summary>
		///<returns>
		///List-IDAOOrdersStatus.
		///</returns>
		///<parameters>
		///
		///</parameters>
		public static List<IDAOOrdersStatus> SelectAll()
		{
			Doing(null);
			MySqlCommand	command = new MySqlCommand();
			command.CommandText = "ctpr_orders_status_getall";
			command.CommandType = CommandType.StoredProcedure;
			MySqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
			...
			try
			{
				...
				List<IDAOOrdersStatus> objList = new List<IDAOOrdersStatus>();
				if(dt.Rows.Count > 0)
				{
					foreach(DataRow row in dt.Rows)
					{
						DAOOrdersStatus retObj = new DAOOrdersStatus();
		...
		public static Int32 SelectAllCount()
		{
			Doing(null);
			MySqlCommand	command = new MySqlCommand();
			command.CommandText = "ctpr_orders_status_getallcount";
			command.CommandType = CommandType.StoredProcedure;
			MySqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		///This method returns specific fields of all data rows in the table using criteriaquery apiorders_status
		///</Summary>
		///<returns>
		...
		public static IDictionary<string, IList<object>> SelectAllByCriteriaProjection(IList<IDataProjection> listProjection, IList<IDataCriterion> listCriterion, IList<IDataOrderBy> listOrder, IDataSkip dataSkip, IDataTake dataTake)
		{
			Doing(null);
			MySqlCommand	command = new MySqlCommand();
			command.CommandText = "ctpr_orders_status_getbyprojection";
			command.CommandType = CommandType.StoredProcedure;
			MySqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		///This method returns all data rows in the table using criteriaquery api orders_status
		///</Summary>
		///<returns>
		///List-IDAOOrdersStatus.
		///</returns>
		...
		///</parameters>
		public static List<IDAOOrdersStatus> SelectAllByCriteria(IList<IDataCriterion> listCriterion, IList<IDataOrderBy> listOrder, IDataSkip dataSkip, IDataTake dataTake)
		{
			Doing(null);
			MySqlCommand	command = new MySqlCommand();
			command.CommandText = "ctpr_orders_status_getbycriteria";
			command.CommandType = CommandType.StoredProcedure;
			MySqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		public static Int32 SelectAllByCriteriaCount(IList<IDataCriterion> listCriterion)
		{
			Doing(null);
			MySqlCommand	command = new MySqlCommand();
			command.CommandText = "ctpr_orders_status_getbycriteriacount";
			command.CommandType = CommandType.StoredProcedure;
			MySqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		///This method allows the object to update itself in the table orders_status based on its primary key(s)
		///</Summary>
		///<returns>
		///void
		///</returns>
		...
		public virtual void Update()
		{
			Doing(this);
			MySqlCommand	command = new MySqlCommand();
			command.CommandText = "ctpr_orders_status_updateone";
			command.CommandType = CommandType.StoredProcedure;
			command.Connection = _connectionProvider.Connection;
